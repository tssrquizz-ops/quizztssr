...
body.vt-light{--bg:#ffffff;--bg2:#f4f4f8;--panel:#ffffff;--border:#e0e0e8;--border2:#c8c8d8;--text:#1a1a2e;--text2:#4a4a6a;--dim:#9090b0;--white:#1a1a2e;--sh:rgba(0,0,0,.08);}
/* cat accents */
...
.hero-card-srs{border-color:#fb923c;}
...
.hero-card-srs .hero-card-title{color:#fb923c;}
...
.hero-card-srs .hero-card-badge{background:rgba(251,146,60,.15);border-color:#fb923c;color:#fb923c;}
...
/* ===================== PROFIL ===================== */
#screen-profile{padding:20px 0;}
.profile-card{background:var(--panel);border:1.5px solid var(--border);border-radius:12px;overflow:hidden;margin-bottom:16px;}
.profile-banner{height:80px;background:linear-gradient(135deg,var(--acc),var(--a2));}
.profile-avatar-wrap{position:relative;margin:-32px 0 0 20px;width:64px;height:64px;background:var(--panel);border:3px solid var(--panel);border-radius:50%;display:flex;align-items:center;justify-content:center;font-size:34px;cursor:pointer;transition:transform .15s;}
.profile-avatar-wrap:hover{transform:scale(1.1);}
.profile-info{padding:10px 20px 18px;}
.profile-name{font-family:monospace;font-size:14px;color:var(--text);font-weight:bold;margin-bottom:3px;}
.profile-title-badge{display:inline-block;font-family:monospace;font-size:7px;padding:3px 10px;border-radius:12px;border:1.5px solid var(--acc);color:var(--acc);background:var(--a2);margin-bottom:6px;}
.profile-promo{font-family:monospace;font-size:9px;color:var(--text2);}
.profile-stats-row{display:grid;grid-template-columns:repeat(3,1fr);gap:8px;margin-bottom:16px;}
.profile-stat{background:var(--panel);border:1.5px solid var(--border);border-radius:7px;padding:12px 8px;text-align:center;}
.profile-stat-val{font-family:monospace;font-size:14px;display:block;margin-bottom:3px;}
.profile-form{background:var(--panel);border:1.5px solid var(--border);border-radius:8px;padding:18px;}
.profile-form-lbl{font-family:monospace;font-size:7px;color:var(--dim);letter-spacing:2px;text-transform:uppercase;margin-bottom:6px;display:block;}
.profile-input{width:100%;background:var(--bg2);border:1.5px solid var(--border2);border-radius:6px;padding:10px 14px;font-family:'DM Mono',monospace;font-size:13px;color:var(--text);outline:none;margin-bottom:12px;box-sizing:border-box;transition:border-color .2s;}
.profile-input:focus{border-color:var(--acc);}
.profile-save-btn{width:100%;padding:12px;background:var(--acc);border:none;border-radius:6px;font-family:monospace;font-size:9px;color:var(--bg);cursor:pointer;letter-spacing:1px;}
.avatar-picker{display:none;position:fixed;inset:0;z-index:9900;background:rgba(0,0,0,.7);align-items:center;justify-content:center;}
.avatar-picker.show{display:flex;}
.avatar-picker-box{background:var(--panel);border:1.5px solid var(--border2);border-radius:12px;padding:20px;max-width:340px;width:100%;}
.avatar-grid{display:grid;grid-template-columns:repeat(7,1fr);gap:8px;margin-bottom:14px;}
.avatar-opt{font-size:26px;text-align:center;cursor:pointer;padding:6px;border-radius:8px;transition:all .12s;border:2px solid transparent;}
.avatar-opt:hover,.avatar-opt.selected{background:var(--a2);border-color:var(--acc);}
...
/* ===================== MULTIBLANK ===================== */
.mbk-code{background:var(--bg2);border:1.5px solid var(--border);border-radius:6px;padding:14px 16px;font-family:'DM Mono',monospace;font-size:13px;color:var(--text);line-height:2.2;margin-bottom:12px;white-space:pre-wrap;}
...
/* ===================== HOTSPOT ===================== */
.hs-diagram{background:var(--bg2);border:1.5px solid var(--border);border-radius:8px;padding:18px 20px;font-family:'DM Mono',monospace;font-size:12px;color:var(--text);line-height:2;margin-bottom:14px;white-space:pre;overflow-x:auto;position:relative;}
...
#app { max-width: 860px; padding: 0 24px 80px; }
@media (min-width: 860px) {
  #app { max-width: 860px; padding: 0 48px 80px; }
}
...
@media (min-width: 900px) {
  #app { max-width: 1100px; padding: 0 28px 60px; }
...
body.ui-neon::before { background-image:radial-gradient(rgba(56,189,248,.06) 1px, transparent 1px); background-size:32px 32px; opacity:.6; }
...
#screen-online-duel{
  position:fixed!important;inset:0!important;z-index:800!important;
  background:var(--bg)!important;display:none;flex-direction:column;
  overflow-y:auto;
}
#screen-online-duel.active{display:flex!important;}
