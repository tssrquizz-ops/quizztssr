...
function lsSet(k,v){
  try{
    ...
    if(window._fbUser&&window.fbSaveUserData){
      clearTimeout(window._fbSaveTimer);
      window._fbSaveTimer=setTimeout(window.fbSaveUserData,2000);
    }
  }catch(e){
    if (e.name === 'QuotaExceededError' || e.name === 'NS_ERROR_DOM_QUOTA_REACHED') {
      ...
      catch(e2) { alert('Stockage du navigateur plein. Impossible de sauvegarder votre progression.'); }
    }
  }
}
...
// ============================================================
// PROFIL, LEADERBOARD ET OBJECTIFS
// ============================================================
// Ces sections ont été migrées vers js/profile.js pour
// une meilleure modularité et pour centraliser la sécurité anti-XSS.
